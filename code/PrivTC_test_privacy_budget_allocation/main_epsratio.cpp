...
int main()
{
    ...
    for (double eps_ratio = 0.9; eps_ratio >= 0.09; eps_ratio -= 0.2)
    {
        double epsilon = 2.0;
        double epsilon1 = epsilon * eps_ratio;
        ...
        c_relative_error /= 10;
        f_relative_error /= 10;
        std::cout << "time:" <<"eps_ratio:" << eps_ratio << "epsilon1:" << epsilon1 << " " << "epsilon2:" << epsilon2 << " " << "LDP_avg_time:" << LDP_avg_time << std::endl;
